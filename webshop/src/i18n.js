...
const resources = {
  en: {
    translation: {
      ...
      "cart.empty-text": "Cart is empty",
      "cart.total": "Total in cart",
    }
  },
  et: {
    translation: {
      "menu.cart": "Ostukorv",
      "menu.shops": "Poed",
      "menu.contact": "Kontakteeru",
      "menu.login": "Logi sisse",
      "menu.signup": "Registreeru",
      "cart.empty-button": "Tühjenda",
      "cart.empty-text": "Ostukorv on tühi",
      "cart.total": "Ostukorvi summa kokku",
    }
  }
};
